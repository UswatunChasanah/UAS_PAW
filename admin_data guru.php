...
<head>
  ...
  <title>Data Guru | TK Dharma Wanita</title>
  <style>
    h5,
    h1 {
      text-align: center;
  ...
  <div style="margin-left:15%">
    ...
    <div class="container mt-2">
      <div class="container mt-2">
        <div class="row mt-5">
          <div class="col">
            <h3 style="color:black; text-align:left; font-weight:bold;">Data Guru</h3>
          </div>
          <div class="col">
            ...
            ?>
              <tr>
                ...
                <td>
                  ...
                  <a href="detail guru.php?id=<?php echo $row["id"] ?>"><button type="button" class="btn btn-primary">Show Detail</button></a>
                </td>
              </tr>
            <?php
              $no += 1;
