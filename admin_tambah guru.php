...
<head>
  ...
  <title>TK Dharma Wanita | Home Admin</title>
  <style>
    h5,
    h1 {
      text-align: center;
                  ...
                  <form method="POST" action="insert_guru.php">
                    ...
                    <div class="row">
                      <div class="col mb-2">
                        ...
                        <div class="form-outline">
                          <input type="text" id="firstName" class="form-control form-control-lg" name="nama_guru" />
                    ...
                    <div class="row">
                      <div class="col-md-6 mb-2 d-flex align-items-center">
                        ...
                        <div class="form-outline datepicker w-100">
                          <input type="date" class="form-control form-control-lg" id="birthdayDate" name="tgl_lahir_guru" />
                      ...
                      <div class="col-md-6 mb-2">
                        <div class="form-outline datepicker w-100">
                          <input type="text" class="form-control form-control-lg" id="birthdayDate" name="NIP" />
                          <label for="birthdayDate" class="form-label">NIP</label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6 mb-2 pb-2">
                        ...
                        <div class="form-outline">
                          <input type="text" id="emailAddress" class="form-control form-control-lg" name="nomor_tlp_guru" />
