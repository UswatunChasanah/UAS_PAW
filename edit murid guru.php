...
if (!$hasil) {
  echo "<script> alert('Data gagal diedit'); document.location.href='guru_data_murid.php';</script>";
} else {
  echo "<script> alert('Data berhasil diedit'); document.location.href='guru_data_murid.php';</script>";
}
